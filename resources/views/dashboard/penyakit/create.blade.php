				...
				<div class="p-6 bg-white border-b border-gray-200">
					<form action="{{ route('penyakit.store') }}" method="post">
						...
						<div class="mt-2">
							...
							<x-input id="penyakit" class="block mt-1 w-full" type="text" name="penyakit" :value="old('penyakit')" required />
						</div>
						...
						<div class="mt-2">
							...
							<x-textarea id="solusi" class="block mt-1 w-full" name="solusi" :value="old('solusi')"></x-textarea>
						</div>
